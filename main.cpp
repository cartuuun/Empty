...
void print_resume_basic(resume r)
{
    //changeColor(3);
    cout<<"\n\n\t\t\t\t RESUME";
    //changeColor(6);
...
void print_default_resume_template()
{
    ...
    print_resume_basic(resume_creation);
    print_education();
    edu[0].print_edu();
    edu[1].print_edu();
    print_expirence();
...
void create_user_resume()
{
    ...
    print_resume_basic(resume_create);
    print_education();
    int n=0;
    while(n<edu)
    {
    ...
    while(n<proj)
    {
        get_proj[n].print_proj();
        n++;
    }
    print_additional_info();
    get_a_info.print_add_info();
